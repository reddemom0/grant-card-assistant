/**
 * Loan & Financing Readiness Assessment Template
 * Generic professional template for loan programs
...
export const READINESS_ASSESSMENT = {
  ...
  // Default placeholders for loan programs
  defaultData: {
    program_name: '[Grant/Loan Name]',
    funder: '[Funder Name]',
    program_description: '[Summary of Funder and Loan/Financing Program].',
    ...
    funding_type: 'repayable loan / non-repayable grant / hybrid',
