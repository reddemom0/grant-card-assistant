    ...
    properties: {
      ...
      sub_skill: {
        ...
        enum: [
          ...
          'FOUNDATIONS', 'COMPANY_CONTEXT', 'GRANT_BLASTS', 'BLOGS', 'OTHER_CONTENT', 'DATA_SOURCES',
