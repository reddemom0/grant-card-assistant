...
export const agentSDKConfig = {
  // Model Configuration
  model: 'claude-sonnet-4-5-20250929', // Sonnet 4.5 (Sept 2025)
  fallbackModel: 'claude-haiku-4-5', // Fallback to Haiku 4.5 if Sonnet unavailable
  ...
  tools: {
    ...
    'getgranted-ai': ['Read', 'Glob', 'Grep', 'WebSearch', 'WebFetch', 'TodoWrite', 'Memory'], // Client-facing grant assistant
