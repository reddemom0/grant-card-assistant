...
Use **canexport-preparedness-rubric.md** from Google Drive knowledge base.
...
🟢 **Green (75%+)**: Application-ready
- Typical 10-day drafting timeline
- 70-85% approval probability

🟡 **Yellow (60-74%)**: Need 2-3 weeks to close gaps before drafting
- 50-70% approval probability

🔴 **Red (40-59%)**: Major gaps
- 4-6 weeks to get application-ready
- 30-50% approval probability

⛔ **Not a Fit (<40%)**: Significant concerns
- Recommend deferral or alternative programs
...
## 2. Claims Risk Assessment

**CRITICAL**: Review ALL prep documents (Budget, RA, Interview responses) against the claims risk database.
...
**OPTIONAL** - If transcript provided by team member.
...
1. **canexport-preparedness-rubric.md** - For scoring system
2. **canexport-claims-risk-database.md** - For risk assessment

Use `search_google_drive` and `read_google_drive_file` to access.

---

Use this skill when:
- Team member asks you to assess client readiness
- You need to score a completed budget/RA/interview package
- You're identifying risky activities that may get rejected
- You're developing an application strategy brief
- You're analyzing meeting transcripts for insights
